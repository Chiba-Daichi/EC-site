...
public class AdminController {
	...
	public String welcome(LoginForm form,Model model) {
		...
		if(user.getIsAdmin() == 0) {
			model.addAttribute("errMssage", "管理者ではありません。");
			return "forward:/ecsite/admin/";
		}
	...
	public String addGods(GoodsForm goodsForm, LoginForm loginForm, Model m) {
	...
	public String deleteApi(@RequestBody GoodsForm f,Model model) {
		try {
